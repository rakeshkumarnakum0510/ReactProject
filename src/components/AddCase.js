    ...
    return (
     ...
     <Formik
                ...
                validationSchema={Yup.object().shape({
                  ...
                  newcase: Yup.string()
                         .required('New case is required'),
                  newdeath: Yup.string()
                        .required('New death is required')
                })}
                onSubmit={fields => {
                  toast.success("Success");
                    CaseService.create(fields)  .then(response => {
                ...
                render={({ errors, status, touched }) => (
                    <Form>
                        <div className="form-group">
                            ...
                            <Field as="select" name="title" className={'form-control' + (errors.title && touched.title ? ' is-invalid' : '')} >
                        ...
                        <div className="form-group">
                            ...
                            <Field  name="newdeath" type="number"  className={'form-control' + (errors.newdeath && touched.newdeath ? ' is-invalid' : '')}    placeholder="Enter today's deaths"   />
                            <ErrorMessage name="newdeath" component="div" className="invalid-feedback" />
                        </div>
                        <div className="form-group">
